...
_ABOUT_MD = (
    ...
    "good-out-of-the-box defaults and **fifteen render looks** - photoreal, "
    "clay, shadow study, showroom, and a stylised drawing/print family: linework, "
    "pen, sketch, cel, hatch, yellowtrace, brown paper, blueprint, diagram, "
    "watercolor, and risograph - plus "
    "an interactive **Open View** session, scale-true **2D plans / elevations / "
    "sections**, saved views with batch rendering, a 15-look contact sheet, and "
